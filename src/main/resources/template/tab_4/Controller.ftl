...
public class ${table_name}Controller {
    ...
    */
    ...
    public ResponseEntity<PageInfo<${table_name}>> findAndPageUsers(@RequestParam(required = false, defaultValue = "1") Integer pageNum,
        ...
        ResponseEntity<PageInfo<${table_name}>> responseEntity = new ResponseEntity<PageInfo<${table_name}>>(pageInfo, HttpStatus.OK);
        return responseEntity;
    }
