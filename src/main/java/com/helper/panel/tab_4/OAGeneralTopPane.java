 ...
 * @date 2018/3/2 16:39
 */
public class OAGeneralTopPane extends JPanel{
    ...
    public OAGeneralTopPane() {
        ...
        gbc.gridy++;
        add((datasourceIP = new JTextField("172.31.0.53",10)), gbc);
        gbc.gridy++;
        add((datasourcePort = new JTextField("1521",10)), gbc);
        gbc.gridy++;
        add((datasourceName = new JTextField("33",10)), gbc);
        gbc.gridy++;
        add((datasourceUsername = new JTextField("22",10)), gbc);
        gbc.gridy++;
        add((datasourcePassword = new JPasswordField("1111",10)), gbc);
        gbc.gridy++;
        add(new JLabel(" "), gbc);
        gbc.gridy++;
