...
public class OAGeneralCenterPane extends JPanel {
    ...
    public OAGeneralCenterPane() {
        ...
        add((tableNameField = new JTextField("tbl_requisition_contract",10)), gbc);
        ...
        gbc.gridy++;
        add((tableAnnotationField = new JTextField("contract table",10)), gbc);
