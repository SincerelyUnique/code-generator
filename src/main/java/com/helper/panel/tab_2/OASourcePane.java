...
public class OASourcePane extends JPanel{
    ...
    public OASourcePane() {
        ...
        gbc.gridy++;
        add((datasourceIP = new JTextField("172.31.0.93",10)), gbc);
        gbc.gridy++;
        add((datasourcePort = new JTextField("1521",10)), gbc);
        gbc.gridy++;
        add((datasourceName = new JTextField("oadev",10)), gbc);
        gbc.gridy++;
        add((datasourceUsername = new JTextField("oa",10)), gbc);
        gbc.gridy++;
        add((datasourcePassword = new JPasswordField("oa",10)), gbc);
        gbc.gridy++;
        add(new JLabel(" "), gbc);
        gbc.gridy++;
